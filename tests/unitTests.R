...
test_dir("C:/Ceres/GitHub/LandscapesInMotion/R/SpaDES/m/fire_STSM/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("C:/Ceres/GitHub/LandscapesInMotion/R/SpaDES/m/fire_STSM/tests/testthat/test-template.R")
